        ...
        <div className="flex flex-col justify-center items-center gap-8 md:gap-20 2xl:gap-24">
          ...
          <div className="flex flex-col gap-5 w-full px-5">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-primary p-6 md:px-12 md:py-10 text-white font-bold text-2xl md:text-3xl 2xl:text-5xl rounded-xl md:rounded-3xl w-full text-center hover:bg-fuchsia-600 transition-colors duration-300 ease-in-out"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-tertiary p-6 md:px-12 md:py-10 text-white font-bold text-2xl md:text-3xl 2xl:text-5xl rounded-xl md:rounded-3xl w-full text-center hover:bg-purple-700 transition-colors duration-300 ease-in-out"
            >
              COMPRE NA AMAZON
            </a>
          </div>
